        ...
        <media-video-layout>
          <media-controls class="vds-controls">
            ...
            <div class="vds-controls-group top-controls">
              <div class="brand-text">OTA LMS</div>
            </div>
          </media-controls>
        </media-video-layout>
      </media-player>
...
.vds-video-layout {
  ...
  --media-tooltip-enter-animation: vds-tooltip-enter 0.3s cubic-bezier(0.4, 0, 0.2, 1);
  --media-tooltip-exit-animation: vds-tooltip-exit 0.2s cubic-bezier(0.4, 0, 0.2, 1);
